...
- **figma:** add hover/active/loading variants to 9 interactive components ([b90a792](https://github.com/DominikPieper/atelier-ui/commit/b90a792))

### 🔥 Performance

- **docs:** shrink logo PNGs 585 KB → 37 KB via sips resize ([355353a](https://github.com/DominikPieper/atelier-ui/commit/355353a))
...
- **docs:** remove stale v1.0.4-beta badge from sidebar ([2ec08e8](https://github.com/DominikPieper/atelier-ui/commit/2ec08e8))
...
- **create-workspace:** pass e2eTestRunner: 'none' to framework app generators ([b6c7413](https://github.com/DominikPieper/atelier-ui/commit/b6c7413))
- **docs:** drop <Image> for logo to work around Astro 6 cold-build ENOENT ([ae5c718](https://github.com/DominikPieper/atelier-ui/commit/ae5c718))
...
- **create-workspace:** always write preflight npm script in scaffolded package.json ([8813785](https://github.com/DominikPieper/atelier-ui/commit/8813785))
