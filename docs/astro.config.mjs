...
export default defineConfig({
  ...
  integrations: [
    ...
    astroBrokenLinksChecker({
      ...
      // Storybook subtrees are built after docs in the Cloudflare Worker build
      // chain (wrangler.jsonc), so /storybook-*/ links are flagged here as
      // false positives. The checker has no exclude option (upstream issue);
      // throwError stays false.
    }),
