# Storybook Vue MCP — Atelier UI

## What this skill does
Provides component documentation for the Atelier UI Vue component library via the Model Context Protocol (MCP). Use this to look up accurate component props, types, defaults, and usage examples before generating Vue code.
