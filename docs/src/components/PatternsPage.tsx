  ...
  return (
    <div style={{ maxWidth: '400px', width: '100%' }}>
      <AtlCard variant="elevated" padding="lg">
        ...
        <AtlCardFooter>
          <AtlButton variant="primary" loading={loading} onClick={handleSubmit}>
            Sign in
          </AtlButton>
        </AtlCardFooter>
      </AtlCard>
...
export function SettingsPageDemo() {
  ...
  return (
    <div style={{ maxWidth: '640px', width: '100%' }}>
      ...
      >
        <AtlButton variant="primary" onClick={() => setSuccess(true)}>
          Save changes
        </AtlButton>
      ...
      {confirmed && (
        <div style={{ marginTop: '1rem' }}>
          <AtlAlert
            variant="success"
            dismissible
            onDismissed={() => setConfirmed(false)}
          >
...
const dataListRows = [
  {
    ...
    description: 'Brand-refresh landing page',
    status: 'Active',
  ...
  },
  {
    id: 2,
    name: 'Mobile App v2',
    description: 'Cross-platform rewrite in Flutter',
    status: 'In Review',
  ...
  },
  {
    id: 3,
    name: 'API Gateway',
    description: 'Microservices ingress layer',
    status: 'Draft',
  ...
  },
  {
    ...
    description: 'PHP monolith → Node services',
    status: 'Paused',
        ...
        <AtlAccordionItem expanded headingLevel={4}>
          ...
          >
            <AtlAlert variant="danger">
              Database connection failed on replica-3.
            </AtlAlert>
    ...
    >
      ...
      >
        ...
        <AtlTabGroup
          variant="pills"
          selectedIndex={range}
          onSelectedIndexChange={setRange}
        >
          ...
          <AtlCard key={m.label} variant="elevated" padding="md">
            <AtlCardContent>
              ...
              >
                ...
                <AtlBadge variant={m.deltaVariant} size="sm">
                  {m.delta}
                </AtlBadge>
              </div>
              <p
