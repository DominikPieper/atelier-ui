...
export class AtlCombobox implements FormValueControl<string> {
  ...
  readonly options = input<AtlComboboxOption[]>([]);
  ...
  /** @internal */
  protected readonly panelId = `atl-combobox-panel-${nextId}`;

  /** @internal */
  protected readonly errorId = `atl-combobox-errors-${nextId++}`;
