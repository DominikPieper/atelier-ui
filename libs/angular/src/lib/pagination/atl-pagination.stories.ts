...
export default meta;
type Story = StoryObj<AtlPagination>;

export const Default: Story = {
  render: (args) => ({
    props: { ...args, page: signal(args.page) },
    moduleMetadata: { imports: [AtlPagination] },
    template: `
      <atl-pagination
        [(page)]="page"
        [pageCount]="pageCount"
...
export const MiddlePage: Story = {
  render: (args) => ({
    ...
    moduleMetadata: { imports: [AtlPagination] },
    template: `
      <atl-pagination [(page)]="page" [pageCount]="pageCount" [siblingCount]="siblingCount" [showFirstLast]="showFirstLast" />
    `,
  }),
...
export const NoFirstLast: Story = {
  render: (args) => ({
    ...
    moduleMetadata: { imports: [AtlPagination] },
    template: `
      <atl-pagination [(page)]="page" [pageCount]="pageCount" [siblingCount]="siblingCount" [showFirstLast]="false" />
    `,
  }),
...
export const SinglePage: Story = {
  render: () => ({
    props: { page: signal(1) },
    moduleMetadata: { imports: [AtlPagination] },
    template: `<atl-pagination [(page)]="page" [pageCount]="1" />`,
  }),
};
