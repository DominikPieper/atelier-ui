...
export class AtlSelect implements FormValueControl<string>, AtlSelectContext, OnDestroy {
  ...
  /** @internal */
  protected readonly triggerId = `atl-select-trigger-${nextId}`;

  /** @internal */
  protected readonly panelId = `atl-select-panel-${nextId}`;

  /** @internal */
  protected readonly errorId = `atl-select-errors-${nextId++}`;
