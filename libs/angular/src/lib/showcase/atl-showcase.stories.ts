  ...
  template: `
    <div style="max-width: 860px; margin: 0 auto; padding: 2rem 1.5rem;">
      <header style="margin-bottom: 3rem;">
        <h1
          style="font-size: 1.75rem; font-weight: 700; margin-bottom: 0.25rem; letter-spacing: -0.02em;"
        >
          Component Showcase
        </h1>
      ...
      <section style="margin-bottom: 3rem;">
        ...
        <div class="section-body">
          ...
          <atl-alert variant="success"
            >Your changes were saved successfully.</atl-alert
          >
          <atl-alert variant="warning"
            >Your session will expire in 5 minutes.</atl-alert
          >
          <atl-alert variant="danger"
            >Something went wrong. Please try again.</atl-alert
          >
          <atl-alert variant="info" [dismissible]="true"
            >This alert can be dismissed.</atl-alert
          >
        </div>
      </section>
      ...
      <section style="margin-bottom: 3rem;">
        ...
        <div class="section-body">
          <div class="row">
            <atl-checkbox [(checked)]="checkboxChecked"
              >Accept terms and conditions</atl-checkbox
            >
            <atl-checkbox [checked]="true" [indeterminate]="true"
              >Indeterminate</atl-checkbox
            >
            <atl-checkbox [checked]="true" [disabled]="true"
              >Disabled</atl-checkbox
            >
          </div>
        </div>
      </section>
      ...
      <section style="margin-bottom: 3rem;">
        ...
        <div class="section-body">
          <div class="row">
            ...
            <atl-toggle [checked]="false" [disabled]="true"
              >Disabled</atl-toggle
            >
          </div>
        </div>
        ...
        <div class="section-body">
          <atl-radio-group [(value)]="radioValue" name="plan">
            <div class="row">
              ...
              <atl-radio radioValue="legacy" [disabled]="true"
                >Legacy (disabled)</atl-radio
              >
            </div>
          </atl-radio-group>
        </div>
        ...
        <div class="section-body">
          <div style="max-width: 300px;">
            <atl-select [(value)]="selectValue" placeholder="Select a country">
              ...
              <atl-option optionValue="jp" [disabled]="true"
                >Japan (unavailable)</atl-option
              >
            </atl-select>
          </div>
        </div>
      ...
      <section style="margin-bottom: 3rem;">
        ...
        <div class="section-body">
          <atl-tab-group [(selectedIndex)]="tabIndex">
            <atl-tab label="Overview"
              >Overview — general information about the item.</atl-tab
            >
            <atl-tab label="Details"
              >Detailed specifications and technical information.</atl-tab
            >
            <atl-tab label="History"
              >Historical records and activity log.</atl-tab
            >
            <atl-tab label="Disabled" [disabled]="true"
              >Not accessible.</atl-tab
            >
          </atl-tab-group>
          ...
          <div class="row">
            ...
            <ng-template #actionsMenu>
              <atl-menu>
                ...
                <atl-menu-item [disabled]="true"
                  >Delete (disabled)</atl-menu-item
                >
              </atl-menu>
            </ng-template>
          </div>
