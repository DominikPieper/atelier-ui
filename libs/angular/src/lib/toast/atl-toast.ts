...
@Component({
  ...
  `,
  styleUrl: './atl-toast.css',
  host: {
    '[class]': 'hostClasses()',
    role: 'status',
  },
})
export class AtlToast {
...
@Component({
  ...
  `,
  styleUrl: './atl-toast-container.css',
  host: {
    '[class]': 'hostClasses()',
    'aria-live': 'polite',
    role: 'status',
...
export class AtlToastContainer {
  protected readonly toastService = inject(AtlToastService);
