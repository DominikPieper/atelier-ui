...
describe('AtlAccordionGroup', () => {
  ...
  covers('accordion', 'home-end')(
    'Home focuses the first header and End the last',
    async () => {
      const user = userEvent.setup();
      render(
        <AtlAccordionGroup>
          <AtlAccordionItem>
            <AtlAccordionHeader>Section One</AtlAccordionHeader>One
          </AtlAccordionItem>
          <AtlAccordionItem>
            <AtlAccordionHeader>Section Two</AtlAccordionHeader>Two
          </AtlAccordionItem>
          <AtlAccordionItem>
            <AtlAccordionHeader>Section Three</AtlAccordionHeader>Three
          </AtlAccordionItem>
        </AtlAccordionGroup>,
      );
  ...
  covers('accordion', 'wrap')(
    'ArrowDown wraps from the last header to the first',
    async () => {
      const user = userEvent.setup();
      render(
        <AtlAccordionGroup>
  ...
  covers('accordion', 'collapse-on-click')(
    'collapses an expanded item on second click',
    async () => {
      const user = userEvent.setup();
      render(
        <AtlAccordionGroup>
  ...
  covers('accordion', 'single-collapse-other')(
    'in single-expand mode, opening one collapses another',
    async () => {
      const user = userEvent.setup();
      render(
  ...
  covers('accordion', 'disabled-no-toggle')(
    'does not toggle a disabled item',
    async () => {
      const user = userEvent.setup();
      render(
        <AtlAccordionGroup>
