...
export const Small: Story = {
  args: { variant: 'default', size: 'sm', children: 'New' },
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
        <AtlBadge variant="default" size="sm">
          Default sm
        </AtlBadge>
      ...
      <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
        <AtlBadge variant="default" size="md">
          Default md
        </AtlBadge>
        <AtlBadge variant="success" size="md">
          Success md
        </AtlBadge>
        <AtlBadge variant="warning" size="md">
          Warning md
        </AtlBadge>
        <AtlBadge variant="danger" size="md">
          Danger md
        </AtlBadge>
        <AtlBadge variant="info" size="md">
          Info md
        </AtlBadge>
      </div>
    </div>
