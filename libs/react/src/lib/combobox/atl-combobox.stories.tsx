...
const AtlComboboxWrapper = (args: ComponentProps<typeof AtlCombobox>) => {
  const [value, setValue] = useState(args.value ?? '');
  return <AtlCombobox {...args} value={value} onValueChange={setValue} />;
};

export const Default: Story = {
  render: (args) => <AtlComboboxWrapper {...args} />,
  args: {
    options: FRUITS,
