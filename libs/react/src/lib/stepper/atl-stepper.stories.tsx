...
export const WithErrorStep: Story = {
  render: () => (
    <AtlStepper activeStep={2}>
      ...
      <AtlStep label="Profile" error>
        Profile had an error
      </AtlStep>
      <AtlStep label="Review">Review content</AtlStep>
    </AtlStepper>
  ),
...
export const WithOptionalStep: Story = {
  render: () => (
    <AtlStepper>
      ...
      <AtlStep label="Profile" optional>
        Profile content
      </AtlStep>
      <AtlStep label="Review">Review content</AtlStep>
    </AtlStepper>
  ...
  return (
    <AtlStep label={label}>
      ...
      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
        <AtlButton variant="outline" size="sm" onClick={prev}>
          Back
        </AtlButton>
        <AtlButton variant="primary" size="sm" onClick={next}>
          Next
        </AtlButton>
      </div>
    </AtlStep>
