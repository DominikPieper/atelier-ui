...
describe('LlmTable', () => {
  ...
  describe('LlmTh — sorting', () => {
    ...
    it('sets aria-sort="none" when sortable and sortDirection=null', () => {
      const { container } = render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection={null}>Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
    ...
    it('sets aria-sort="ascending" when sortDirection="asc"', () => {
      const { container } = render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection="asc">Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
    ...
    it('sets aria-sort="descending" when sortDirection="desc"', () => {
      const { container } = render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection="desc">Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
    ...
    it('emits "asc" on first click (cycling from null)', async () => {
      ...
      render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection={null} onSort={onSort}>Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
    ...
    it('emits "desc" on second click (cycling from asc)', async () => {
      ...
      render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection="asc" onSort={onSort}>Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
      await user.click(screen.getByRole('button'));
    ...
    it('emits null on third click (cycling from desc)', async () => {
      ...
      render(
        <LlmTable>
          <LlmThead><LlmTr><LlmTh sortable sortDirection="desc" onSort={onSort}>Name</LlmTh></LlmTr></LlmThead>
          <LlmTbody />
        </LlmTable>
      );
      await user.click(screen.getByRole('button'));
  ...
  describe('LlmTr — row selection', () => {
    ...
    it('emits onSelectedChange=true when checkbox is checked', async () => {
      ...
      render(
        <LlmTable>
          <LlmTbody>
            <LlmTr selectable selected={false} onSelectedChange={onChange}>
              <LlmTd>Row</LlmTd>
            </LlmTr>
          </LlmTbody>
        </LlmTable>
    ...
    it('sets aria-selected on the tr when selectable=true', () => {
      const { container } = render(
        <LlmTable>
          <LlmTbody>
            <LlmTr selectable selected={true}><LlmTd>Row</LlmTd></LlmTr>
          </LlmTbody>
        </LlmTable>
      );
  ...
  describe('LlmTbody — empty state', () => {
    ...
    it('applies the colSpan value to the empty-state td', () => {
      const { container } = render(
        <LlmTable>
          <LlmTbody empty colSpan={3} emptyContent="Empty" />
        </LlmTable>
      );
