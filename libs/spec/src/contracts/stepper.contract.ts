...
export const contract = {
  ...
  axisMap: [
    ...
    },
    {
      ...
      values: { error: true },
      reason: 'Same master description as the completed mapping above — the error flag also lives on the child AtlStep.',
    },
    {
      figmaAxis: 'state',
      codeProp: 'AtlStep.optional',
      values: { optional: true },
      reason: 'Same master description as the completed mapping above — the optional flag also lives on the child AtlStep.',
    },
  ],
