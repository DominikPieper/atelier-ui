...
export const metadata: ComponentMetadata = {
  ...
  antiPatterns: [
    {
      ...
      useInstead:
        'AtlAvatar or a plain `<img>` — icons are abstract glyphs, not raster content.',
    },
    {
      pattern:
        'Conveying status without an adjacent label and without setting `label`.',
      useInstead:
        'Pair the icon with visible text or pass `label` — decorative icons are hidden from screen readers.',
    },
  ],
  ...
  variantMatrix: [{ size: 'sm' }, { size: 'md' }, { size: 'lg' }],
  accessibility: {
    role: 'img',
