...
export const tokens: Record<string, TokenAnnotation> = {
  ...
  '--ui-font-size-xs': {
    intent:
      'Smallest readable size (0.75rem). Use for badges, captions, table meta, and dense labels.',
    constraints: [
  ...
  '--ui-font-size-sm': {
    intent:
      'Compact size (0.875rem). Use for secondary text, helper messages, and dense form labels.',
    constraints: [
  ...
  '--ui-font-size-md': {
    intent:
      'Body copy size (1rem). The default for paragraphs and form inputs.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
  ...
  '--ui-font-size-lg': {
    intent:
      'Emphasised body / small headings (1.125rem). Use for card titles and dialog headings.',
    constraints: [
  ...
  '--ui-font-size-xl': {
    intent:
      'Section heading size (1.25rem). Use for page sub-headings and modal titles.',
    constraints: [
  ...
  '--ui-font-size-2xl': {
    intent:
      'Largest in-app heading (1.5rem). Use for page titles inside product surfaces.',
    constraints: [
  ...
  '--ui-letter-spacing-tight': {
    intent:
      'Negative tracking (-0.01em) for large headings to prevent loose appearance.',
    constraints: [
  ...
  '--ui-letter-spacing-wide': {
    intent:
      'Positive tracking (0.01em) for all-caps labels, badges, and eyebrows.',
    constraints: [
  ...
  '--ui-letter-spacing-uppercase': {
    intent:
      'Tracking for uppercased text (0.08em). Caps need far more space between letters than mixed case.',
    constraints: [
  ...
  '--ui-control-height-sm': {
    intent:
      'Height of a small interactive control (2rem). Buttons, inputs, selects, chips that sit in dense rows.',
    constraints: [
  ...
  '--ui-control-height-md': {
    intent:
      'Height of the default interactive control (2.5rem). The size a form row is built from.',
    constraints: [
  ...
  '--ui-control-height-lg': {
    intent:
      'Height of a large interactive control (3rem). Primary actions and touch-first surfaces.',
    constraints: [
      'Derive block padding from this, do not state it.',
  ...
  '--ui-font-weight-normal': {
    intent:
      'Default body weight (400). Use for paragraphs and regular UI text.',
    constraints: [
  ...
  '--ui-font-weight-medium': {
    intent:
      'Subtle emphasis weight (500). Use for form labels, button text, and table headers.',
    constraints: [
  ...
  '--ui-font-weight-semibold': {
    intent:
      'Strong emphasis weight (600). Use for headings and primary calls-to-action.',
    constraints: [
  ...
  '--ui-font-weight-bold': {
    intent:
      'Bold (700). The heaviest weight in the system; carries headline-level emphasis.',
    constraints: [
  ...
  '--ui-type-title': {
    intent:
      'Title role: semibold 1.125rem. Card headers, dialog titles, section labels inside a component.',
    constraints: [
      'Do not use for body copy — the weight fights sustained reading.',
    ],
  },
  '--ui-type-body-lg': {
    intent:
      'Body role, large (1.125rem). Lead paragraphs and the first screen of a reading surface.',
    constraints: ['One lead per surface; the rest of the copy is body-md.'],
  },
  '--ui-type-body-md': {
    intent:
      'Body role, default (1rem). The workhorse — every paragraph and every interactive label unless a role says otherwise.',
    constraints: ['If unsure which role a piece of text is, it is this one.'],
  },
  '--ui-type-body-sm': {
    intent:
      'Body role, small (0.875rem). Helper text, table meta, secondary descriptions.',
    constraints: [
      'Pair with --ui-color-text-muted so the size and the colour agree about importance.',
    ],
  },
  '--ui-type-label': {
    intent:
      'Label role: medium 0.75rem. Eyebrows, overlines, badge text, form labels in dense layouts.',
    constraints: [
  ...
  '--ui-type-code': {
    intent:
      'Code role: JetBrains Mono at 0.875rem. Inline code, tokens, prop names, keyboard chips, terminal output.',
    constraints: [
  ...
  '--ui-color-teal-100': {
    intent:
      'Very light teal. The pressed state of a primary control in the dark theme.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Never for text on the light canvas; these steps are for fills and dark-theme surfaces.',
    ],
  ...
  '--ui-color-teal-300': {
    intent:
      'Light-mid teal. The primary of the dark theme; carries text on the dark canvas at 10.83:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-teal-400': {
    intent:
      'Mid teal. Fills and illustration on dark; on the light canvas it clears 3:1 for UI but not 4.5:1 for text.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-teal-500': {
    intent:
      'Mid teal, the lightest step that still carries normal text on the DARK canvas (5.73:1).',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-teal-600': {
    intent:
      'Deep teal, the lightest step that still carries normal text on the LIGHT canvas (4.76:1).',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-teal-700': {
    intent:
      'The brand anchor. The primary of the light theme; carries text on the light canvas at 6.87:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  ...
  '--ui-color-teal-900': {
    intent:
      'Darkest teal. The pressed state in the light theme, and the deepest text-safe step.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-100': {
    intent:
      'Step 100 of the red ramp; the light theme’s --ui-color-danger-bg. Carries normal text on the dark canvas at 15.56:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-200': {
    intent:
      'Step 200 of the red ramp; the dark theme’s --ui-color-danger-active. Carries normal text on the dark canvas at 13.14:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-300': {
    intent:
      'Step 300 of the red ramp; the dark theme’s --ui-color-danger-hover and --ui-color-danger-text. Carries normal text on the dark canvas at 10.02:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-400': {
    intent:
      'Step 400 of the red ramp; the dark theme’s --ui-color-danger. Carries normal text on the dark canvas at 6.87:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-500': {
    intent:
      'Step 500 of the red ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 5.25:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-red-600': {
    intent:
      'Step 600 of the red ramp, generated to complete the scale — no token aliases it today. Carries normal text on the light canvas at 4.82:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the danger family keeps one vocabulary.',
    ],
  ...
  '--ui-color-red-700': {
    intent:
      'The anchor of the red ramp and the light theme’s --ui-color-danger. Carries normal text on the light canvas at 6.47:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-800': {
    intent:
      'Step 800 of the red ramp; the light theme’s --ui-color-danger-hover and --ui-color-danger-text. Carries normal text on the light canvas at 8.31:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-900': {
    intent:
      'Step 900 of the red ramp; the light theme’s --ui-color-danger-active. Carries normal text on the light canvas at 10.02:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-red-950': {
    intent:
      'Step 950 of the red ramp; the dark theme’s --ui-color-danger-bg. Carries normal text on the light canvas at 16.28:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-green-100': {
    intent:
      'Step 100 of the green ramp; the light theme’s --ui-color-success-bg. Carries normal text on the dark canvas at 17.31:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-green-200': {
    intent:
      'Step 200 of the green ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 15.37:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-green-300': {
    intent:
      'Step 300 of the green ramp; the dark theme’s --ui-color-success-text. Carries normal text on the dark canvas at 13.54:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-green-400': {
    intent:
      'Step 400 of the green ramp; the dark theme’s --ui-color-success. Carries normal text on the dark canvas at 10.91:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-green-500': {
    intent:
      'Step 500 of the green ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 7.91:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the success family keeps one vocabulary.',
    ],
  ...
  '--ui-color-green-600': {
    intent:
      'Step 600 of the green ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 5.52:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the success family keeps one vocabulary.',
    ],
  ...
  '--ui-color-green-700': {
    intent:
      'The anchor of the green ramp and the light theme’s --ui-color-success. Carries normal text on the light canvas at 5.02:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-green-800': {
    intent:
      'Step 800 of the green ramp; the light theme’s --ui-color-success-text. Carries normal text on the light canvas at 7.13:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-green-900': {
    intent:
      'Step 900 of the green ramp, generated to complete the scale — no token aliases it today. Carries normal text on the light canvas at 8.51:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the success family keeps one vocabulary.',
    ],
  ...
  '--ui-color-green-950': {
    intent:
      'Step 950 of the green ramp; the dark theme’s --ui-color-success-bg. Carries normal text on the light canvas at 13.86:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'A surface tint, not a text colour — its chroma is deliberately below the 900.',
    ],
  ...
  '--ui-color-amber-100': {
    intent:
      'Step 100 of the amber ramp; the light theme’s --ui-color-warning-bg. Carries normal text on the dark canvas at 17.07:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-amber-200': {
    intent:
      'Step 200 of the amber ramp; the dark theme’s --ui-color-warning-text. Carries normal text on the dark canvas at 15.26:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-amber-300': {
    intent:
      'Step 300 of the amber ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 13.24:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-amber-400': {
    intent:
      'Step 400 of the amber ramp; the dark theme’s --ui-color-warning. Carries normal text on the dark canvas at 11.39:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-amber-500': {
    intent:
      'Step 500 of the amber ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 8.15:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the warning family keeps one vocabulary.',
    ],
  ...
  '--ui-color-amber-600': {
    intent:
      'Step 600 of the amber ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 5.63:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the warning family keeps one vocabulary.',
    ],
  ...
  '--ui-color-amber-700': {
    intent:
      'The anchor of the amber ramp and the light theme’s --ui-color-warning. Carries normal text on the light canvas at 5.02:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-amber-800': {
    intent:
      'Step 800 of the amber ramp; the light theme’s --ui-color-warning-text. Carries normal text on the light canvas at 6.85:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-amber-900': {
    intent:
      'Step 900 of the amber ramp, generated to complete the scale — no token aliases it today. Carries normal text on the light canvas at 8.36:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the warning family keeps one vocabulary.',
    ],
  ...
  '--ui-color-amber-950': {
    intent:
      'Step 950 of the amber ramp; the dark theme’s --ui-color-warning-bg. Carries normal text on the light canvas at 14.46:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'A surface tint, not a text colour — its chroma is deliberately below the 900.',
    ],
  ...
  '--ui-color-sky-100': {
    intent:
      'Step 100 of the sky ramp; the light theme’s --ui-color-info-bg. Carries normal text on the dark canvas at 16.57:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-sky-200': {
    intent:
      'Step 200 of the sky ramp; the dark theme’s --ui-color-info-text. Carries normal text on the dark canvas at 14.33:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-sky-300': {
    intent:
      'Step 300 of the sky ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 11.37:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
  ...
  '--ui-color-sky-400': {
    intent:
      'Step 400 of the sky ramp; the dark theme’s --ui-color-info. Carries normal text on the dark canvas at 8.87:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-sky-500': {
    intent:
      'Step 500 of the sky ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 6.46:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the info family keeps one vocabulary.',
    ],
  ...
  '--ui-color-sky-600': {
    intent:
      'Step 600 of the sky ramp, generated to complete the scale — no token aliases it today. Carries normal text on the dark canvas at 4.59:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the info family keeps one vocabulary.',
    ],
  ...
  '--ui-color-sky-700': {
    intent:
      'The anchor of the sky ramp and the light theme’s --ui-color-info. Carries normal text on the light canvas at 5.93:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-sky-800': {
    intent:
      'Step 800 of the sky ramp, generated to complete the scale — no token aliases it today. Carries normal text on the light canvas at 7.75:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'Unused by any semantic token. Alias it before use so the info family keeps one vocabulary.',
    ],
  ...
  '--ui-color-sky-900': {
    intent:
      'Step 900 of the sky ramp; the light theme’s --ui-color-info-text. Carries normal text on the light canvas at 9.46:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
    ],
  },
  '--ui-color-sky-950': {
    intent:
      'Step 950 of the sky ramp; the dark theme’s --ui-color-info-bg. Carries normal text on the light canvas at 15.91:1.',
    constraints: [
      'Primitive: do not reference from component CSS, use the semantic token that aliases this step.',
      'A surface tint, not a text colour — its chroma is deliberately below the 900.',
    ],
  ...
  '--ui-font-size-2xs': {
    intent:
      'Smaller than the smallest readable size (0.625rem). For text inside a box too small to hold --ui-font-size-xs: the initials in a 24px avatar and the count in its overflow badge.',
    constraints: [
  ...
  '--ui-color-primary': {
    intent:
      'Primary call-to-action colour and link text. Brand anchor on light backgrounds.',
    constraints: [
  ...
  '--ui-color-primary-hover': {
    intent:
      'Hover state for primary surfaces and links — one shade deeper than --ui-color-primary.',
    constraints: [
  ...
  '--ui-color-primary-active': {
    intent:
      'Pressed / active state for primary surfaces — deepest step of the primary ramp.',
    constraints: ['Only use as :active state — never as a resting fill.'],
  },
  '--ui-color-primary-light': {
    intent:
      'Soft tinted background for selected / hovered ghost states and subtle primary surfaces.',
    constraints: [
  ...
  '--ui-color-secondary': {
    intent:
      'Neutral secondary action colour (slate). Use for opt-in secondary buttons and chrome.',
    constraints: [
  ...
  '--ui-color-secondary-hover': {
    intent:
      'Hover state for secondary surfaces — one shade deeper than --ui-color-secondary.',
    constraints: [
      'Only use as :hover / :focus-visible state — never as a resting fill.',
    ],
  },
  '--ui-color-secondary-active': {
    intent:
      'Pressed / active state for secondary surfaces — deepest step of the secondary ramp.',
    constraints: ['Only use as :active state — never as a resting fill.'],
  },
  ...
  '--ui-color-danger': {
    intent:
      'Destructive action and error signal colour. Use for delete buttons and form errors.',
    constraints: [
  ...
  '--ui-color-danger-hover': {
    intent:
      'Hover state for danger surfaces — one shade deeper than --ui-color-danger.',
    constraints: [
      'Only use as :hover / :focus-visible state — never as a resting fill.',
    ],
  },
  '--ui-color-danger-active': {
    intent:
      'Pressed / active state for danger surfaces — deepest step of the danger ramp.',
    constraints: ['Only use as :active state — never as a resting fill.'],
  },
  '--ui-color-success': {
    intent:
      'Positive confirmation signal colour. Use for success buttons and confirmation icons.',
    constraints: [
      'Pair with text + icon — never rely on colour alone for state.',
      'Do not use for decorative emphasis.',
  ...
  '--ui-color-info': {
    intent:
      'Informational signal colour. Use for info alerts and neutral notifications.',
    constraints: [
      'Pair with text + icon — never rely on colour alone for state.',
      'Do not use for decorative emphasis.',
    ],
  ...
  '--ui-color-success-bg': {
    intent:
      'Tinted background for success badges, alerts, and toasts. AA-safe pair with --ui-color-success-text.',
    constraints: [
  ...
  '--ui-color-success-text': {
    intent:
      'AA-safe foreground for use on --ui-color-success-bg in success badges, alerts, and toasts.',
    constraints: [
  ...
  '--ui-color-warning-bg': {
    intent:
      'Tinted background for warning badges, alerts, and toasts. AA-safe pair with --ui-color-warning-text.',
    constraints: [
  ...
  '--ui-color-warning-text': {
    intent:
      'AA-safe foreground for use on --ui-color-warning-bg in warning badges, alerts, and toasts.',
    constraints: [
  ...
  '--ui-color-danger-bg': {
    intent:
      'Tinted background for danger badges, alerts, and toasts. AA-safe pair with --ui-color-danger-text.',
    constraints: [
  ...
  '--ui-color-danger-text': {
    intent:
      'AA-safe foreground for use on --ui-color-danger-bg in danger badges, alerts, and toasts.',
    constraints: [
  ...
  '--ui-color-info-bg': {
    intent:
      'Tinted background for info badges, alerts, and toasts. AA-safe pair with --ui-color-info-text.',
    constraints: [
  ...
  '--ui-color-info-text': {
    intent:
      'AA-safe foreground for use on --ui-color-info-bg in info badges, alerts, and toasts.',
    constraints: [
  ...
  '--ui-color-surface': {
    intent:
      'Base page background. The canvas every other surface elevates from.',
    constraints: [
  ...
  '--ui-color-surface-raised': {
    intent:
      'Slightly elevated surface for cards, popovers, and panels resting above the page.',
    constraints: [
      'Pair with --ui-color-text or --ui-color-text-muted only — never raw black/white.',
  ...
  '--ui-color-surface-sunken': {
    intent:
      'Recessed surface for input fields, code blocks, and inset containers.',
    constraints: [
      'Pair with --ui-color-text or --ui-color-text-muted only — never raw black/white.',
  ...
  '--ui-color-border': {
    intent:
      'Decorative border for cards, dividers, and resting input outlines. Below 3:1 contrast — informational only.',
    constraints: [
  ...
  '--ui-color-border-hover': {
    intent:
      'Hover state for decorative borders — slightly deeper than --ui-color-border.',
    constraints: ['Only use as :hover state — never as a resting border.'],
  },
  '--ui-color-border-strong': {
    intent:
      'Functional border meeting >=3:1 contrast (WCAG 1.4.11). Use for input outlines, focus rings, and meaningful dividers.',
    constraints: [
  ...
  '--ui-color-text': {
    intent:
      'Primary body and heading text colour. Use on --ui-color-surface and its raised/sunken variants.',
    constraints: [
  ...
  '--ui-color-text-muted': {
    intent:
      'Secondary text colour for helper copy, captions, and de-emphasised content.',
    constraints: [
  ...
  '--ui-color-text-on-primary': {
    intent:
      'Foreground colour for text and icons rendered on --ui-color-primary fills.',
    constraints: [
  ...
  '--ui-color-text-on-secondary': {
    intent:
      'Foreground colour for text and icons rendered on --ui-color-secondary fills.',
    constraints: [
      'Only use as foreground on the matching brand surface; contrast is guaranteed against that surface and no other.',
    ],
  },
  '--ui-color-text-on-danger': {
    intent:
      'Foreground colour for text and icons rendered on --ui-color-danger fills.',
    constraints: [
      'Only use as foreground on the matching brand surface; contrast is guaranteed against that surface and no other.',
    ],
  },
  '--ui-color-text-on-success': {
    intent:
      'Foreground colour for text and icons rendered on --ui-color-success fills.',
    constraints: [
      'Only use as foreground on the matching brand surface; contrast is guaranteed against that surface and no other.',
    ],
  },
  ...
  '--ui-color-brand-corporate': {
    intent:
      'Conciso corporate teal. Reference brand colour — opt-in for components that need it.',
    constraints: [
  ...
  '--ui-color-brand-agile': {
    intent:
      'Conciso Agile sub-brand colour (mint). Opt-in for Agile-themed surfaces.',
    constraints: [
  ...
  '--ui-color-brand-architecture': {
    intent:
      'Conciso Architecture sub-brand colour (deep teal). Opt-in for Architecture-themed surfaces.',
    constraints: [
  ...
  '--ui-color-brand-development': {
    intent:
      'Conciso Development sub-brand colour (bright blue). Opt-in for Development-themed surfaces.',
    constraints: [
  ...
  '--ui-color-brand-petrol': {
    intent:
      'Conciso deep petrol accent. Opt-in for dark brand surfaces and accents.',
    constraints: [
  ...
  '--ui-color-brand-ai': {
    intent:
      'Conciso AI sub-brand colour (lime). Opt-in for AI-themed surfaces and accents.',
    constraints: [
  ...
  '--ui-color-brand-light-blue': {
    intent:
      'Conciso light-blue accent. Opt-in for bright brand highlights and gradients.',
    constraints: [
  ...
  '--ui-color-brand-light-green': {
    intent:
      'Conciso light-green accent. Opt-in for bright brand highlights and gradients.',
    constraints: [
  ...
  '--ui-radius-sm': {
    intent:
      'Small rounding (0.5rem) for compact controls — badges, tags, inline chips.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-radius-md': {
    intent:
      'Default rounding for interactive surfaces — buttons, inputs, cards. Modern, mildly soft.',
    constraints: [
  ...
  '--ui-radius-lg': {
    intent:
      'Large rounding for prominent panels — modals, popovers, hero cards.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  ...
  '--ui-radius-full': {
    intent:
      'Fully rounded (pill) shape. Use for avatar masks, status dots, and pill buttons.',
    constraints: [
  ...
  '--ui-row-height-md': {
    intent:
      'The default repeating row: a table row, a list row that holds md-step controls.',
    constraints: [
  ...
  '--ui-spacing-1': {
    intent:
      'Hairline spacing (0.25rem). Use for icon-to-label gaps and tightest groupings.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-2': {
    intent:
      'Tight spacing (0.5rem). Use for compact button padding and dense list rows.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-3': {
    intent:
      'Snug spacing (0.75rem). Use for default form-control padding and chip insets.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-4': {
    intent:
      'Default inter-element spacing (1rem). Use for gaps inside cards, between form fields, between list items.',
    constraints: [
  ...
  '--ui-spacing-5': {
    intent:
      'Comfortable spacing (1.25rem). Use for card padding and form section gaps.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-6': {
    intent:
      'Loose spacing (1.5rem). Use for dialog padding and prominent component insets.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-8': {
    intent:
      'Section spacing (2rem). Use between distinct content blocks on a page.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-10': {
    intent:
      'Wide section spacing (2.5rem). Use for separation between major page sections.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-12': {
    intent:
      'Generous section spacing (3rem). Use for page-level layout gutters.',
    constraints: [
      'Do not interpolate between scale steps; pick the nearest defined value.',
    ],
  },
  '--ui-spacing-16': {
    intent:
      'Largest scale step (4rem). Use for hero/landing-page rhythm and top-level layout offsets.',
    constraints: [
  ...
  '--ui-shadow-xs': {
    intent:
      'Minimal elevation — a faint shadow used for inputs and resting interactive controls.',
    constraints: [
  ...
  '--ui-shadow-sm': {
    intent:
      'Low elevation for resting cards and panels that lift slightly off the page.',
    constraints: [
      'Combine with a 1px subtle border for clarity on busy backgrounds.',
  ...
  '--ui-shadow-lg': {
    intent:
      'High elevation for popovers, menus, and floating panels detached from the page.',
    constraints: [
  ...
  '--ui-shadow-xl': {
    intent:
      'Maximum elevation for modals and command palettes that own the screen.',
    constraints: [
  ...
  '--ui-ease-out': {
    intent:
      'Decelerating easing curve. Use for entrances and elements arriving on screen.',
    constraints: [
  ...
  '--ui-ease-in-out': {
    intent:
      'Symmetrical easing curve. Use for elements moving across the screen.',
    constraints: [
      'Use --ui-ease-out for entrances, --ui-ease-in-out for movement, --ui-ease-spring for emphasised transitions.',
    ],
  },
  '--ui-ease-spring': {
    intent:
      'Overshoot easing curve. Use sparingly for emphasised transitions (e.g. toasts, success confirmations).',
    constraints: [
      'Use --ui-ease-out for entrances, --ui-ease-in-out for movement, --ui-ease-spring for emphasised transitions.',
  ...
  '--ui-duration-fast': {
    intent:
      'Short transition (150ms). Use for hover/focus state changes and micro-interactions.',
    constraints: [
  ...
  '--ui-duration-normal': {
    intent:
      'Default transition (200ms). Use for property changes on interactive components.',
    constraints: [
      'Respects prefers-reduced-motion via the @media block — do not override durations elsewhere.',
  ...
  '--ui-duration-slow': {
    intent:
      'Long transition (300ms). Use for enter/exit animations on overlays and panels.',
    constraints: [
      'Respects prefers-reduced-motion via the @media block — do not override durations elsewhere.',
  ...
  '--ui-transition-fast': {
    intent:
      'Composed transition shorthand: fast duration + ease-out. Use for hover/focus micro-interactions.',
    constraints: [
  ...
  '--ui-transition-normal': {
    intent:
      'Composed transition shorthand: normal duration + ease-out. Default for interactive state changes.',
    constraints: [
  ...
  '--ui-transition-slow': {
    intent:
      'Composed transition shorthand: slow duration + ease-out. Use for enter/exit animations.',
    constraints: [
  ...
  '--ui-focus-ring': {
    intent:
      'Double-ring box-shadow for :focus-visible — surface-coloured inner + primary outer for light/dark compatibility.',
    constraints: [
  ...
  '--ui-color-input-bg': {
    intent:
      'Resting background for text inputs, selects, and textareas. Sunken to read as fillable.',
    constraints: [
  ...
  '--ui-color-input-bg-focus': {
    intent:
      'Focused background for text inputs — lifts to surface level to signal active editing.',
    constraints: [
  ...
  '--ui-color-input-border': {
    intent:
      'Resting border for text inputs, selects, and textareas. Functional (>=3:1 contrast).',
    constraints: [
  ...
  '--ui-color-input-border-hover': {
    intent:
      'Hover state for input borders — one shade deeper than --ui-color-input-border.',
    constraints: ['Only use as :hover state — never as a resting border.'],
  },
  '--ui-color-input-border-focus': {
    intent:
      'Focused border for inputs — primary-coloured to match the focus ring.',
    constraints: [
  ...
  '--ui-color-error-text': {
    intent:
      'Foreground colour for inline form error messages. Aliased to --ui-color-danger-text.',
    constraints: [
  ...
  '--ui-z-dropdown': {
    intent:
      'Stacking level for popovers, dropdowns, and menus that float above page content.',
    constraints: [
      'Layer ordering: base < dropdown < overlay < modal < toast. Do not exceed the scale; if you need more, restructure.',
    ],
  },
  ...
  '--ui-z-modal': {
    intent:
      'Stacking level for modal dialogs and drawers that own the foreground.',
    constraints: [
      'Layer ordering: base < dropdown < overlay < modal < toast. Do not exceed the scale; if you need more, restructure.',
  ...
  '--ui-z-toast': {
    intent:
      'Top stacking level for transient toasts and notifications — above modals so they remain visible.',
    constraints: [
      'Layer ordering: base < dropdown < overlay < modal < toast. Do not exceed the scale; if you need more, restructure.',
