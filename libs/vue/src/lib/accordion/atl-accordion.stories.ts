...
const TWO_ITEM_TEMPLATE = `
  <AtlAccordionGroup>
    <AtlAccordionItem>
      <template #header><AtlAccordionHeader>Section 1</AtlAccordionHeader></template>
      Content 1
    </AtlAccordionItem>
    <AtlAccordionItem>
      <template #header><AtlAccordionHeader>Section 2</AtlAccordionHeader></template>
      Content 2
    </AtlAccordionItem>
  </AtlAccordionGroup>
`;
