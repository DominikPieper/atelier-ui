...
function capture() {
  ...
  let r = render(LlmButton, { slots: { default: 'Click me' } });
  scenarios.default = a11yTree(r.container);
  r.unmount();
  r = render(LlmButton, { props: { disabled: true }, slots: { default: 'Click me' } });
  scenarios.disabled = a11yTree(r.container);
  r.unmount();
  r = render(LlmButton, { props: { loading: true }, slots: { default: 'Click me' } });
