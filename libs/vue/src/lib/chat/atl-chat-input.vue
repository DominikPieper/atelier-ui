...
import { AtlChatKey } from './atl-chat.vue';

defineOptions({ name: 'AtlChatInput' });

interface AtlChatInputProps {
  value?: string;
  placeholder?: string;
  ariaLabel?: string;
}

const props = withDefaults(defineProps<AtlChatInputProps>(), {
  value: undefined,
  placeholder: '',
