...
**29 components.** Claude Design coverage: **0 designed**, 3 appearing only as a fragment inside a study, 26 untouched.
...
| `button` | fragment only | variant · size · state | 24 | 2026-07-21 (`2ac9047`) | all 3 | — | yes |
