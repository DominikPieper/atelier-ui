...
/* ─────────────────────────────── Components grid ─────────────────────────────── */
const COMPONENTS = [
  { name: 'AtlButton', desc: 'Primary action. 4 variants, 3 sizes.', icon: 'B', cat: 'Inputs' },
  { name: 'AtlInput', desc: 'Text field with validation states.', icon: 'I', cat: 'Inputs' },
  { name: 'AtlTextarea', desc: 'Multi-line input. Auto-resize opt-in.', icon: 'T', cat: 'Inputs' },
  { name: 'AtlCheckbox', desc: 'Boolean input with indeterminate state.', icon: '☐', cat: 'Inputs' },
  { name: 'AtlRadio', desc: 'Mutually exclusive selection.', icon: '◉', cat: 'Inputs' },
  { name: 'AtlSelect', desc: 'Single-select dropdown.', icon: '▾', cat: 'Inputs' },
  { name: 'AtlCombobox', desc: 'Filterable, type-ahead select.', icon: '▾', cat: 'Inputs' },
  { name: 'AtlSwitch', desc: 'Two-state toggle.', icon: '⊙', cat: 'Inputs' },
  { name: 'AtlCard', desc: 'Composable container — Header, Content, Footer.', icon: 'C', cat: 'Display' },
  { name: 'AtlBadge', desc: 'Inline status pill.', icon: '●', cat: 'Display' },
  { name: 'AtlAvatar', desc: 'User identity glyph with fallback.', icon: '◯', cat: 'Display' },
  { name: 'AtlTable', desc: 'Sortable, virtualised data table.', icon: '☷', cat: 'Display' },
  { name: 'AtlTabs', desc: 'Lazy panel switcher. ARIA tabs.', icon: '┉', cat: 'Navigation' },
  { name: 'AtlStepper', desc: 'Linear progress through a flow.', icon: '⇉', cat: 'Navigation' },
  { name: 'AtlBreadcrumbs', desc: 'Hierarchical location.', icon: '/', cat: 'Navigation' },
  { name: 'AtlDialog', desc: 'Modal surface. Focus-trap, Esc-close.', icon: '▢', cat: 'Overlay' },
  { name: 'AtlPopover', desc: 'Anchored, dismissable surface.', icon: '◆', cat: 'Overlay' },
  { name: 'AtlTooltip', desc: 'Pointer-triggered hint.', icon: '?', cat: 'Overlay' },
  { name: 'AtlToast', desc: 'Transient notification.', icon: '!', cat: 'Overlay' },
  { name: 'AtlDropdown', desc: 'Action menu with arrow-key nav.', icon: '⋮', cat: 'Overlay' },
  { name: 'AtlAccordion', desc: 'Collapsible region group.', icon: '⌃', cat: 'Display' },
  { name: 'AtlAlert', desc: 'Inline status banner.', icon: '◭', cat: 'Display' },
  { name: 'AtlProgress', desc: 'Determinate + indeterminate.', icon: '▰', cat: 'Display' },
  { name: 'AtlSlider', desc: 'Single + dual-thumb range.', icon: '─', cat: 'Inputs' },
  { name: 'AtlIcon', desc: '20-name spec set. label = a11y.', icon: '✦', cat: 'Display' },
  { name: 'AtlSkeleton', desc: 'Loading placeholder shimmer.', icon: '▭', cat: 'Display' },
  { name: 'AtlDivider', desc: 'Section separator. Horizontal/vertical.', icon: '|', cat: 'Display' },
];
