...
- `/schulung/` requires Node 20 _or_ 22, contradicting `engines` and `/troubleshooting` (Node 22 only); mentions pnpm though npm is pinned (`schulung.astro:55`)
